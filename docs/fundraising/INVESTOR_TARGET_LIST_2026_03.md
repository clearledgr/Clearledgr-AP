...
- pre-seed or seed
- fintech and/or finance infrastructure
- enterprise workflow / vertical software
- AI-native application software
- Europe and US venture ecosystems

Scoring:

- Tier A: highest-probability targets to start with now
- Tier B: strong next wave once the first meetings are underway
- Tier C: plausible but more dependent on warm intros, process heat, or stronger pilot proof

Important:

- "Highly probable" here means best fit based on public stage/thesis positioning as of 2026-03-29. It is still an inference, not a guarantee.
- Partner selection matters more than firm logo. For each fund, find the partner most likely to care about fintech, enterprise workflow, or AI-native vertical software.
- Use warm intros wherever possible. Cold outreach should be reserved for funds that clearly invite direct inbound.
...
6. `LocalGlobe` — Europe — Good London anchor for a sharp early-stage software + fintech wedge. Site: [localglobecapital.com](https://localglobecapital.com/)

### US

7. `First Round Capital` — US — Top US seed target if the company is ready for a serious US process and can sell the wedge crisply. Site: [firstround.com](https://www.firstround.com/)
...
13. `Frontline Ventures` — Europe — Very good fit for a European B2B software company with explicit US ambition. Site: [frontline.vc](https://frontline.vc/)
14. `Cherry Ventures` — Europe — Strong pan-European early-stage fund with seed appetite and comfort investing pre-product / pre-revenue. Site: [cherry.vc](https://cherry.vc/)
15. `Episode 1 Ventures` — Europe — Good fit for early B2B software with strong commercial wedge discipline. Site: [episode1.com](https://episode1.com/)
16. `Crane Venture Partners` — Europe — Strong fit for enterprise software and infrastructure-like workflow systems. Site: [crane.vc](https://www.crane.vc/)
17. `Kindred Capital` — Europe — Good early-stage London fund for founder-led software companies. Site: [kindredcapital.vc](https://kindredcapital.vc/)
18. `Passion Capital` — Europe — Good fit if the story stays sharp and product-led; historically strong at early software. Site: [passion.vc](https://passion.vc/)
19. `RTP Global` — Europe/US — Good fit for ambitious early-stage software, AI, and fintech with global aspirations. Site: [rtp.vc](https://rtp.vc/)
20. `Heartcore Capital` — Europe — Good fit for early-stage European tech with strong founder support reputation. Site: [heartcore.com](https://www.heartcore.com/)
21. `Northzone` — Europe/US — Strong if the round gets competitive; fintech and software pattern recognition. Site: [northzone.com](https://northzone.com/)
22. `Connect Ventures` — Europe — Useful for product-led software and strong narrative clarity. Site: [connectventures.com](https://www.connectventures.com/)
...
32. `FPV Ventures` — US — Good fit for infrastructure and workflow software with operational depth. Site: [fpvventures.com](https://fpvventures.com/)

## Tier C

### Europe

33. `Hoxton Ventures` — Europe — Good fit if the software story sharpens and the process gets stronger. Site: [hoxtonventures.com](https://www.hoxtonventures.com/)
34. `MMC Ventures` — Europe — Plausible fit for AI and data-heavy software companies. Site: [mmc.vc](https://www.mmc.vc/)
35. `Project A` — Europe — Good if the company leans into operational software and GTM rigor. Site: [project-a.com](https://www.project-a.com/)
...
42. `True Ventures` — US — Plausible if the round gets stronger and the product story resonates. Site: [trueventures.com](https://trueventures.com/)
43. `Initialized Capital` — US — Good fit if the AI application layer story is unusually crisp. Site: [initialized.com](https://initialized.com/)
44. `Haystack` — US — Worth including for earliest-stage software rounds and network value. Site: [haystack.vc](https://www.haystack.vc/)
45. `South Park Commons Fund` — US — Good if founder quality and category vision resonate strongly. Site: [southparkcommons.com/fund](https://www.southparkcommons.com/fund)
46. `RRE Ventures` — US — Plausible fit if the enterprise + fintech framing is strong. Site: [rre.com](https://www.rre.com/)
47. `Peterson Ventures` — US — Good fit for practical vertical software and founder-led execution stories. Site: [petersonventures.com](https://petersonventures.com/)
48. `XYZ Venture Capital` — US — Good for sharp early-stage B2B stories if the partner fit is there. Site: [xyz.vc](https://xyz.vc/)
49. `Y Combinator` — US — Still worth pursuing if the company wants a top-of-funnel global investor brand plus network. Site: [ycombinator.com](https://www.ycombinator.com/)
50. `Bain Capital Ventures` — US — More competitive and somewhat more mature, but still plausible if the process and pilot evidence sharpen quickly. Site: [baincapitalventures.com](https://www.baincapitalventures.com/)
...
- everyone else on Tier B
- Tier C only through warm paths or once the process has momentum

## Messaging Notes

Lead with this version of the story:
...
## Sources Used For This Shortlist

This shortlist was prioritized using current public positioning from representative official fund sites and team / stage pages, including:
...
- [Heartcore](https://www.heartcore.com/)
- [RTP Global](https://rtp.vc/)
- [First Round](https://www.firstround.com/)
- [Afore](https://www.afore.vc/)
...
Before sending the deck, validate:

1. current partner focus
2. geography fit
3. whether they are still actively leading at pre-seed / seed
4. whether the partner has real fintech / workflow / AI taste
