...
import type { ComposeViewButtonOnClickEvent, ContactNameOptional } from '../../inboxsdk';
...
export type ComposeViewDriverEvent = {
    eventName: 'buttonAdded' | 'bodyChanged' | 'discardCanceled' | 'draftSaved' | 'minimized' | 'resize' | 'restored' | 'sendCanceled' | 'sending' | 'sent' | 'subjectChanged';
    data?: any;
} | {
    eventName: 'destroy';
    data: {
...
//# sourceMappingURL=compose-view-driver.d.ts.map