...
def report_to_pdf(report_payload: Dict[str, Any]) -> bytes:
    ...
    pdf.cell(0, 8, f"Clearledgr · {title}", ln=1)
    ...
    pdf.cell(0, 5, "Generated by Clearledgr · five reports, well-built", ln=1)
...
def audit_events_to_pdf(events, *, org_id: str, params: Dict[str, Any]) -> bytes:
    ...
    pdf.add_page()
    pdf.set_font("Helvetica", "B", 16)
    pdf.cell(0, 8, "Clearledgr · Audit Trail", ln=1)
    pdf.set_font("Helvetica", "", 10)
    ...
    pdf.set_font("Helvetica", "I", 8)
    pdf.set_text_color(120, 120, 120)
    pdf.cell(0, 5, "Generated by Clearledgr · append-only audit", ln=1)
