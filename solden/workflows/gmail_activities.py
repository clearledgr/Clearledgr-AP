...
from solden.services.fuzzy_matching import vendor_similarity
...
from solden.services.slack_notifications import send_with_retry
...
def _detect_discount_opportunity(
    ...
    try:
        from solden.services.discount_optimizer import calculate_discount_opportunity
...
def _normalize_email_type(raw_type: str) -> str:
    ...
    from solden.services.document_routing import VALID_DOCUMENT_TYPES
