...
class ScheduledReportService:
    ...
    async def _deliver_report(self, schedule: Dict[str, Any]) -> None:
        ...
        from solden.services.report_export import generate_report
    ...
    async def _deliver_to_slack(
        ...
        try:
            from solden.services.agent_background import _slack_alert
    ...
    async def _deliver_to_sheets(
        ...
        try:
            from solden.services.sheets_export import export_report_to_sheets
