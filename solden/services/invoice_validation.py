...
class InvoiceValidationMixin:
    ...
    async def _evaluate_deterministic_validation(self, invoice: InvoiceData) -> Dict[str, Any]:
        ...
        erp_preflight = None
        try:
            from solden.integrations.erp_router import erp_preflight_check as _erp_preflight
        ...
        if isinstance(invoice.bank_details, dict) and invoice.bank_details:
            try:
                ...
                from solden.services.iban_change_freeze import (
        ...
        try:
            if invoice.line_items:
                ...
                from solden.integrations.erp_router import _get_cached_chart_of_accounts
        ...
        try:
            ...
            if invoice_currency and invoice_currency != "USD":
                from solden.services.fx_conversion import convert
                org_currency = str(
        ...
        try:
            from solden.services.ap_decision import evaluate_fraud_thresholds
        ...
        try:
            ...
            from solden.core.prompt_guard import scan_invoice_fields
