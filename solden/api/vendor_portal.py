...
from solden.core.portal_auth import PortalSession, require_portal_token
from solden.core.portal_input import (
    PortalInputError,
...
async def _enrich_vendor_background(
    ...
    """
    try:
        from solden.services.vendor_onboarding_lifecycle import (
...
def submit_bank_details(
    ...
    """
    from solden.core.stores.bank_details import normalize_iban, validate_iban
