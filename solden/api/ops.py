...
def get_erp_connection(*args, **kwargs):
    from solden.integrations.erp_router import get_erp_connection as _get_erp_connection
...
def _get_token_store():
    from solden.services.gmail_api import token_store
...
def _runtime_health_snapshot() -> Dict[str, Any]:
    ...
    try:
        ...
        from solden.core.event_queue import STREAM_HIGH, STREAM_STANDARD, GROUP_NAME
        ok = True
...
async def get_autopilot_status(
    ...
    try:
        ...
        from solden.core.database import get_db as _get_runtime_db
