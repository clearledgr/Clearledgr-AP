...
from solden.di.container import container
...
# `solden.services.learning.get_learning_service(organization_id)`
...
async def soft_org_guard(request: Request, user: Optional[object] = None) -> None:
    ...
    try:
        ...
        if auth_header.startswith("Bearer ") or api_key:
            from solden.core.auth import decode_token, _token_data_from_payload
