...
from solden.core.erp_webhook_verify import verify_sap_signature
...
class SapS4HanaIntakeAdapter:
    ...
    async def enrich(
        ...
        try:
            from solden.integrations.erp_sap_s4hana_intake import fetch_intake_context
        ...
        if intake.get("linked_po"):
            try:
                from solden.services.erp_intake_po_sync import upsert_sap_po
                upsert_sap_po(
                    organization_id=organization_id,
