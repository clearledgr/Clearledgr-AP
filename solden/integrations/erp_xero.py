...
async def post_to_xero(
    ...
    xero_journal = {
        ...
        "Narration": entry.get("description", "Auto-generated by Solden"),
        "JournalLines": [],
    }
...
async def post_bill_to_xero(
    ...
    # Tax-code propagation: Solden vat_code -> Xero TaxType per
    ...
    # when no Solden-side vat_code was set.
    if (
...
# Default Solden vat_code -> Xero TaxType map (purchase side).
