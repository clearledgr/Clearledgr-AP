...
def test_ap_skill_registration():
    ...
    assert {"enrich_with_context", "run_validation_gate", "get_ap_decision", "execute_routing", "request_vendor_info", "verify_erp_posting", "check_payment_readiness", "resolve_exception", "analyze_spending"} == tool_names
